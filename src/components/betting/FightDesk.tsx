  ...
  return (
    <div className="flex h-full flex-col gap-3">
      ...
      <div className="grid min-h-0 flex-1 grid-cols-1 grid-rows-[repeat(4,1fr)] gap-3 sm:grid-cols-2 sm:grid-rows-2">
        ...
        <div className="min-h-0">
          <FeatureGate minPlan="elite" title="Closing Line Value (CLV) Tracker" description="How the opening line compares to the current market for the selected fighter. An Elite tool.">
            <CLVPanel me={me} openOdds={openOdds} curOdds={curOdds} curSource={curSource} />
          </FeatureGate>
        </div>
        <div className="min-h-0">
          <FeatureGate minPlan="elite" title="Bankroll / Kelly Suite" description="Kelly stake from the Vex AI edge at the real market price. An Elite tool.">
