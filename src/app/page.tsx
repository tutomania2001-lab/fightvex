...
export default function Home() {
  ...
  const featSim = simulate(fa, fb, { rounds: featured.rounds, runs: 800, shortNoticeA: featured.shortNoticeA, shortNoticeB: featured.shortNoticeB, missedWeightA: featured.missedWeightA, missedWeightB: featured.missedWeightB, injuredA: featured.injuredA, injuredB: featured.injuredB });
