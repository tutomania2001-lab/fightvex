    ...
    <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6">
      ...
      <div className="grid gap-6 lg:grid-cols-[1fr_320px]">
        ...
        <aside className="space-y-4">
          ...
          <Panel className="reveal p-5">
            <h2 className="mb-2 font-display text-lg font-bold uppercase">Go Pro</h2>
            ...
            <Link href="/pricing" className="btn-flare mt-3 inline-block rounded-md px-4 py-2 text-xs font-bold uppercase">See Pro →</Link>
          </Panel>
        </aside>
      </div>
    </div>
