...
import { isShortNotice, missedWeight, injured } from "@/lib/data/context.override";
...
export function Simulator({
  ...
  const result = useMemo(() => {
    ...
    const params: SimParams = { rounds, shortNoticeA: snA, shortNoticeB: snB, missedWeightA: missedWeight(aId ?? undefined), missedWeightB: missedWeight(bId ?? undefined), injuredA: injured(aId ?? undefined), injuredB: injured(bId ?? undefined), runs: runs + nonce * 7 };
